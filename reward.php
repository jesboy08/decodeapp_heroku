							   ...
							   <div class="row">
										...
										<div class="reward">
												<div class="panel panel-primary">
													...
													<table class="table table-hover" id="dev-table">
														...
														<div id="add-rewards" class="modal fade" role="dialog">
														  <div class="modal-dialog">
														    ...
														    <div class="modal-content">
														      ...
														      <div class="modal-body">
														       	<div class="form-group">
											                        <input id="reward-name" value='' placeholder="Reward" type="text" class="form-control" />
											                    </div>
											                    <div class="form-group">
											                        <input id="reward-point" value='' placeholder="0" type="text" class="form-control" />
											                    </div>
														      </div>
														      <div class="modal-footer">
														      	<button type="button" class="btn btn-success btn-sm button-add-rewards-modal">Add</button>
														        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
														      </div>
														    </div>
							   		...
							   		<div class="col-md-12" style="margin-top: 2em;">
							   			<div class="profile-userbuttons">
							   				...
							   				<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add-rewards">Add Rewards</button>
